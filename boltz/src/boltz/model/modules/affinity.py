...
class AffinityModule(nn.Module):
    ...
    def forward(
        ...
        # print("s_inputs:", s_inputs)
        # print("z:", z)
        # print("x_pred:", x_pred)
        # print('feats["token_to_rep_atom"]:', feats["token_to_rep_atom"])
        # print('feats["token_pad_mask"]:', feats["token_pad_mask"])
        # print('feats["mol_type"]:', feats["mol_type"])
        # print('feats["affinity_token_mask"]:', feats["affinity_token_mask"])
