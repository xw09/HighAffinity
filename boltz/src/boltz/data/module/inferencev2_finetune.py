...
class TrainingDataset(torch.utils.data.Dataset):
    """Dataset for training with Boltz2."""
    ...
    def __getitem__(self, idx: int) -> dict:
        """Get an item from the dataset for training."""
        ...
        # Add record information (for reference)
        features["record"] = record
...
class Boltz2InferenceDataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self) -> DataLoader:
        ...
        dataset = TrainingDataset(  # Assuming you have a dataset for training
        ...
        return DataLoader(
            dataset,
            batch_size=5,  # Adjust the batch size for training
